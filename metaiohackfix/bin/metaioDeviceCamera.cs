...
public class metaioDeviceCamera : MonoBehaviour
{
    ...
    IEnumerator Start()
    {
        ...
        cameraPlane = transform.Find("CameraPlane").gameObject;
    ...
    private void HackFixCamera()
    {
#if UNITY_ANDROID
        using (AndroidJavaClass cls = new AndroidJavaClass("com.metaio.hackfix.HackUtils"))
        {
            cls.CallStatic("hackCamera");
        }
#endif
